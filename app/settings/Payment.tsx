...
const Card = memo((props: IPropsCard) => {
  ...
  return (
    <CustomBox className="h-[calc(68px + 2rem)] mb-2 grid grid-cols-12 gap-x-3 gap-y-2 border-[1px] p-4">
      ...
      <div className="col-span-9 md:col-span-6 grid grid-rows-2 gap-2">
